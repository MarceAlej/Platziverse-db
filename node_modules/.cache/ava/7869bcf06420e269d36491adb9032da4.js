...
test.serial('Agent#findById', async t => {
  ...
  t.true(AgentStub.findById.calleOnce, 'findById should be called once');
  t.true(AgentStub.findById.calledWith(id), 'findById should be called with specified id');
  t.deepEqual(agent, agentFixtures.byId(id), 'should be the same');
});
//# sourceMappingURL=/Users/marce/Desktop/Platzi/Platziverse-db/node_modules/.cache/ava/7869bcf06420e269d36491adb9032da4.js.map